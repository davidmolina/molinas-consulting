...
# Challenge
The client founded the company after years serving as the no. 2 for another residential general contractor and coupled with general management experience in the private sector set out to start a new company. The founder had searched high and low for months for an executive coach to structure and setup the new general contracting company without much success.

# Solution
We paired w/ the owner to build out the backoffice, draft an operations handbook, develop naming convention rules, and install a password manager to store logins for the many websites in the government procurement marketplace. Through our executive coaching, we helped the client understand the General Contractor/ Subcontractor Relations, contract compliance and payments terms so that the founder could make the most informed decision on pursuing work as a prime or subcontractor.
