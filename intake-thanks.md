...
<article class="post intake-page intake-thanks">
  <div class="intake-confirmation">
    ...
    <p>This is where we determine if implementation makes sense.</p>
    <a class="button" href="https://calendly.com/davidcmolina/15-min-office-hours-with-david">Book Your Strategy Call</a>
    <p class="note">
      20-30 minutes. We'll review your current system and identify where money
